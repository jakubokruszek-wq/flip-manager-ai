...
const group:WatchedFacebookGroup={id:"1",name:"Łódź",nameVerified:true,url:"https://facebook.com/groups/1",city:"Łódź",district:null,neighborhood:null,priority:"high",keywords:[],enabled:true,accessStatus:"MANUAL_IMPORT",lastCheckedAt:null,importedPosts:0,newToday:0,opportunities:0,lastError:null};
