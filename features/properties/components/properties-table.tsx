...
function MobileMetric({ label, value }: { label: string; value: string }) { return <div className="min-w-0 rounded-xl bg-surface-muted/60 p-3"><p className="text-[11px] leading-4 text-muted-foreground">{label}</p><p className="mt-1 whitespace-nowrap tabular-nums text-[clamp(0.72rem,3.4vw,0.875rem)] font-semibold">{value}</p></div>; }
