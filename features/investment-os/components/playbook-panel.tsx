...
import { ContentList, formatInvestmentText } from "./investment-ui";
...
export function PlaybookPanel({ playbook }: { playbook: DealPlaybook }) {
  return <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
    ...
    <ContentList title="Plan negocjacji" values={playbook.negotiationPlan.map((value) => formatInvestmentText(value) ?? value)} />
