...
const MAX_IMAGES = 5;
const FACEBOOK_SKIP_REASON_CODES: FacebookSkipReasonCode[] = ["NO_REAL_ESTATE_LANGUAGE_AND_TOO_FEW_FIELDS", "FACEBOOK_BUY_REQUEST", "FACEBOOK_RENT_REQUEST", "FACEBOOK_SERVICE_POST", "FACEBOOK_NON_SALE_POST", "FACEBOOK_PROPERTY_FILTER_REJECTED", "FACEBOOK_INTENT_UNKNOWN"];
