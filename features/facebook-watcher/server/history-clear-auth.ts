...
export function authorizeFacebookWatcherAction(request: Request, action: "clear-watcher-history" | "repair-gallery" | "restore-to-finder" | "repair-facebook-orphan"): Response | null {
