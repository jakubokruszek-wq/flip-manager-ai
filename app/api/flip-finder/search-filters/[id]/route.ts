...
import { deleteSearchFilter, getSearchFilter, parseSearchFilterInput, searchFilterWriteFailureResponse, updateSearchFilter } from "@/features/flip-finder/server/search-filters";
...
export async function PATCH(request: Request, { params }: Context) {
  ...
  catch (error) { console.error("FLIP FINDER EDIT WRITE ERROR:", error); return searchFilterWriteFailureResponse(error, "Nie udało się zapisać filtra."); }
}
